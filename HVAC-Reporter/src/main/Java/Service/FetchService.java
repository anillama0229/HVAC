...
public class FetchService {
    ...
    public void setData(){
        ...
        try {
            ...
            if(fetcher instanceof RemoteFile) {
                File f = new File("/home/alama/Documents/myHVAC/HVAC/HVAC-Reporter/data/secondResult.csv");
                f.deleteOnExit();
    ...
    public void setData(int buildingId){
        ...
        try {
            ...
            BufferedWriter writer = null;
            if(fetcher instanceof RemoteFile) {
                File f = new File("/home/alama/Documents/myHVAC/HVAC/HVAC-Reporter/data/firstResult.csv");
                f.deleteOnExit();
                writer = new BufferedWriter(new FileWriter(f));
            }
